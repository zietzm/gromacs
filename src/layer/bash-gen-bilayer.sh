...
python py-top-builder.py gmx-lipids.gro gmx-bilayer.top

grompp -f em.mdp -c gmx-lipids.gro -p gmx-bilayer.top -maxwarn 10 -o em-lipids.tpr
mdrun -deffnm em-lipids -v

grompp -f md-bilayer.mdp -c em-lipids.gro -p gmx-bilayer.top -maxwarn 10 -o md-lipids.tpr
